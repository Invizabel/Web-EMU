...
os.system("sudo apt update && sudo apt install p7zip-full curl wget nginx git npm -y")
...
os.system("git clone https://github.com/raz0red/js7800")
os.system("sudo mkdir /var/www/html/retroarch")
os.system("sudo mkdir /var/www/html/javatari")
os.system("sudo mkdir /var/www/html/js7800")
os.system("sudo mkdir /var/www/html/swotgb")
os.system("sudo cp -r retroarch/* /var/www/html/retroarch")
os.system("sudo cp -r js7800/site/deploy/* /var/www/html/js7800")
os.system("sudo cp -r js7800/src/* /var/www/html/js7800")
